...
func InitServe() {
	...
	http.HandleFunc("/admin/admin", controller.DisplayAdminAdmin)                            // display admin give / take admin role
	http.HandleFunc("/admin/GestionAdmin", controller.DisplayGestionAdmin)                   // cherche via le nom d'utilisateur donné et choix de l'ajoue ou suppresion
	http.HandleFunc("/admin/GestionSelectionAdmin", controller.DisplayGestionSelectionAdmin) // ajoute ou suprime les drois admin
	...
	http.HandleFunc("/changeLogin/gestion", controller.ChangeLoginHandler)                   // ouvre la possibilité de changer de username << need update
